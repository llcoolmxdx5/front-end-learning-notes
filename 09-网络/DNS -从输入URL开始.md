...
2. 如果浏览器自身的缓存里面没有找到对应的条目，那么`Chrome`会搜索操作系统自身的 DNS 缓存
...
![alt](https://user-gold-cdn.xitu.io/2019/5/30/16b0496067f91e09?w=299&h=223&f=png&s=141374)
